...
import { Card, Col, Row, Typography, Empty, Divider, Image, Button, Tag, Space } from 'antd';
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <Space size="middle">
                                <Button
                                    ...
                                    onClick={() =>
                                        updateMutation.mutate(
                                            { id: order.id, status: BillStatus.cancel },
                                            {
                                                onSuccess() {
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        updateMutation.mutate(
                                            { id: order.id, status: BillStatus.confirm },
                                            {
                                                onSuccess() {
